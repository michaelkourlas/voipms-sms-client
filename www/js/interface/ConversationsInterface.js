 ...
 */
var ConversationsInterface = (function () {
    function ConversationsInterface() {
    }
    /**
     * Initializes the conversations interface.
     */
    ConversationsInterface.initialize = function () {
    ...
    ConversationsInterface.displayConversations = function (callback, initial) {
            ...
            function final() {
                ...
                $("a[data-item-type=\"conversations-listview-item\"]").on("click", function () {
                    if ($(this).attr("id").substr(0, 28) === "conversations-listview-item-") {
                        var selectedConversationIndex = parseInt($(this).attr("id").substring(28));
                        var selectedConversation = Conversations.getConversations()[selectedConversationIndex];
...
//# sourceMappingURL=ConversationsInterface.js.map