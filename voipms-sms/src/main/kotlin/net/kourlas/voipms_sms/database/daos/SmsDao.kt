...
interface SmsDao {
    ...
    suspend fun getConversationMessagesFiltered(did: String, contact: String,
                                                filterConstraint: String): List<Sms>
    ...
    suspend fun getConversationMessagesFilteredCount(did: String,
                                                     contact: String,
    ...
    suspend fun getConversationMessagesFilteredWithLimit(did: String,
                                                         contact: String,
                                                         filterConstraint: String,
                                                         itemLimit: Long): List<Sms>
    ...
    suspend fun getConversationMessagesUnreadAfterDate(did: String,
                                                       contact: String,
                                                       date: Long): List<Sms>
    ...
    suspend fun getConversationMessageMostRecent(did: String,
                                                 contact: String): Sms?
    ...
    suspend fun getConversationMessageMostRecentFiltered(did: String,
                                                         contact: String,
                                                         filterConstraint: String): Sms?
    ...
    suspend fun getConversationMessageMostRecentFiltered(did: String,
                                                         contact: String,
                                                         filterConstraint: String,
                                                         numericFilterConstraint: String): Sms?
    ...
    suspend fun getConversationMessageDateMostRecentOutgoing(did: String,
                                                             contact: String): Long?
