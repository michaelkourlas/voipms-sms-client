...
public class Billing {
    ...
    /**
     * Gets the sole instance of the Billing class. Initializes the instance if it does not already exist.
     *
    ...
    public void postDonation(final String token, final Activity sourceActivity) {
        new AsyncTask<Void, Void, Void>() {
            @Override
            protected Void doInBackground(Void... params) {
                try {
