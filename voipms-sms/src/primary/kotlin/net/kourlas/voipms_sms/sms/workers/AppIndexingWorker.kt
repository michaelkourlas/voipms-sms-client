 ...
 */
class AppIndexingWorker(context: Context, params: WorkerParameters) :
    ...
    companion object {
         ...
         */
        fun performIndexing(context: Context) {
            val work = OneTimeWorkRequestBuilder<AppIndexingWorker>().build()
