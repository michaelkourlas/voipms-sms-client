...
(function (_ui) {
    ...
    /**
     * Interface for manipulating the conversation page UI.
     */
    ...
    (function (conversationpage) {
        ...
        /**
         * Displays the specified conversation on the conversation page.
         * @param conversation The conversation to be displayed.
         * @param callback The callback function to call once the conversation has been displayed.
         */
        function display(conversation, callback) {
            ...
            contacts.getContact(null, conversation.messages[0].getRemotePhoneNumber(), function (contact) {
                ...
                for (var i = 0; i < conversation.messages.length; i++) {
                    ...
                    listviewItem.append($("<p class=\"message-text\">" + conversation.messages[i].text + "</p>"));
    ...
    (function (conversationspage) {
        /**
         * Initializes the application's conversations page.
         */
        function initialize() {
            $("body").on("pagecontainerchange", function (event, ui) {
            ...
            conversations.refresh(function (err) {
                ...
                if (conversationsData !== null) {
                    ...
                    async.eachSeries(conversationsData, function (conversation, asyncCallback) {
                        contacts.getContact(null, conversation.getRemotePhoneNumber(), function (contact) {
                            ...
                            var listviewItem = $("<li>");
                            var listviewItemLink = $("<a id=\"conversations-listview-item-" + counter + "\" " + "data-item-type=\"conversations-listview-item\" data-phone-number=\"" + conversation.getRemotePhoneNumber() + "\" href=\"#\">");
                ...
                function finalExec() {
                    ...
                    $("a[data-item-type=\"conversations-listview-item\"]").on("click", function () {
                        showConversation($(this).attr("data-phone-number"));
                    });
